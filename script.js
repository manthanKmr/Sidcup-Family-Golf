...
var cardall = document.querySelectorAll("#cards-container .card");
...
var footerh4all = document.querySelectorAll("#footer-right h4");
footerh4all.forEach(function (elem) {
  elem.addEventListener("mouseenter", function () {
    crsr.style.scale = 3;
    crsr.style.border = "1px solid #fff";
    crsr.style.backgroundColor = "transparent";
...
var iconsall = document.querySelectorAll("#footer .icons");
iconsall.forEach(function (elem) {
  elem.addEventListener("mouseenter", function () {
    crsr.style.scale = 3;
    crsr.style.border = "1px solid #fff";
    crsr.style.backgroundColor = "transparent";
...
var a = document.querySelectorAll(".footer-bottom a, .creator a");
